	...
	<view class="s-page-wrapper">
		...
		<view class="is-20vh has-pdt-60">
			<view class="is-flex is-column is-justify-center  is-align-center is-height-100">
				<image src="../../static/img/common/tea_login.png" mode="aspectFit" class="logoimg"></image>
			</view>
		</view>
		<view class="content">
			<view class="has-mglr-10 ">
				<view class=" has-mgtb-10 ">
					<input type="number" maxlength="11" v-model="login.teacherAcc" placeholder="请输入工号" class="is-input1 "  data-val="teacherAcc" />
				</view>
	...
	export default {
		...
		methods:{
			defaultHandlerLogin:function(){
				...
				uni.request({
					url: 'http://localhost/stuTeaCtct/index.php/app/teacher/login',
					method:'POST',
					data: {
						"account": this.login.teacherAcc,
